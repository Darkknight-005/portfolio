...
const Main = () => {
    ...
    return (
        <main className='w-auto h-screen bg-black/20 snap-y snap-mandatory overflow-y-scroll' id='main'>
            ...
            <div id='about' >
                <div className='
                h-screen snap-start flex items-center flex-col sm:flex-row-reverse md:flex-row-reverse lg:flex-row-reverse lg:px-14 backdrop-blur-lg md:backdrop-blur-sm lg:backdrop-blur-sm dark:bg-gradient-to-tr from-black/80 via-transparent to-white/40 
                ' >
