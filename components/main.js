...
const Main = () => {
    return (
        <main className='w-auto h-screen bg-black/20 snap-y snap-mandatory overflow-y-scroll' id='main'>
            ...
            <div className='h-screen snap-start lg:pl-14 lg:pr-6 pb-10 outline-black' id='home'>
                <div className='h-full relative top-[3%] rounded-md flex flex-col items-center justify-center gap-y-4 backdrop-blur-sm backdrop-opacity-60 backdrop-brightness-75 bg-black/70 text-white px-5 '>
                    <h3 className='text-3xl text-red-600 brightness-200 home_h3'>work in progress</h3>
                    <p className='mx-5 '>
